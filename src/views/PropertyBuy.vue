    ...
    <div v-else class="prop-grid">
      ...
      >
        ...
        <div class="prop-body">
          ...
          <div class="prop-meta">
            <span v-if="p.bedrooms">🛏 {{ p.bedrooms }} beds</span>
            <span v-if="p.bathrooms">🚿 {{ p.bathrooms }} baths</span>
            <span>{{ p.type }}</span>
          </div>
          ...
          <div class="prop-summary">
            ...
            <div class="summary-info">
              ...
              <div class="summary-row">
                ...
                <span class="summary-val">{{ formatRWF(selectedProp?.price) }}</span>
              </div>
              <div class="summary-row">
...
.prop-meta { display: flex; gap: 14px; font-size: 12px; color: var(--text-muted); margin-top: 10px; flex-wrap: wrap; }
...
/* ── Modal ───────────────────────────────────────────────────── */
.modal-backdrop { position: fixed; inset: 0; background: rgba(0,0,0,0.65); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 1rem; }
.modal { background: var(--surface); border: 1px solid var(--border); border-radius: 16px; padding: 2rem; width: 100%; max-width: 560px; max-height: 90vh; overflow-y: auto; position: relative; }
...
.prop-summary { display: flex; gap: 14px; background: rgba(201,168,76,0.06); border: 1px solid rgba(201,168,76,0.2); border-radius: 10px; padding: 12px; }
...
.form-row input, .form-row textarea { background: transparent; border: 1px solid var(--border); border-radius: 8px; padding: 9px 11px; color: var(--text-main); font-family: var(--font); font-size: 13px; outline: none; }
